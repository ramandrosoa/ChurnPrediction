...
## Notebook Content
In the accompanying [notebook].(ChurnPrediction-(1).ipynb) [link](Transformation-to-linearize-the-model.md) , you will find detailed steps of the data analysis process, including:
